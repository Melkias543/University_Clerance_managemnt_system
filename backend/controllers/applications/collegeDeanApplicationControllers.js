...
import { CollegeDeanApplication } from "../../models/applicationModel.js";
import applicationService from "../../services/applicationService.js";
const sendCollegeDeanApplication = async (req, res) => {
  try {
...
const getSingleCollegeDeanApplication = async (req, res) => {
  try {
    const { id } = req.params;
    // console.log("here",id)
...
const aproveOrRejectAtCollegeDean = async (req, res) => {
  try {
    const { id } = req.params;
...
export default {
  sendCollegeDeanApplication,
  getAllApplication,
  getSingleCollegeDeanApplication,
  aproveOrRejectAtCollegeDean,
};
